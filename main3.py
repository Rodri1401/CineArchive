...
def ask_screen_type(preference):
    ...
    if preference == "Cinépolis":
        tradicional_button = tk.Button(question_window, text="Tradicional", command=lambda: set_screen_type("Tradicional"))
        tradicional_button.pack()

        pluus_button = tk.Button(question_window, text="PLUUS", command=lambda: set_screen_type("PLUUS"))
        pluus_button.pack()
        ...
        question_label = tk.Label(question_window, text="Cinépolis")
        question_label.pack()
        ...
        question_label = tk.Label(question_window, text="Cinemex")
        question_label.pack()
        ...
        question_label = tk.Label(question_window, text="Cualquier formato")
        question_label.pack()

        tradicional_button = tk.Button(question_window, text="Buscar cine más cercano", command=lambda: set_screen_type("Tradicional"))
        tradicional_button.pack()
...
def get_theater_with_smallest_difference(postal_code, preference, screen_type):
    ...
    if preference == "Cinemex":
        query += " AND MovieTheater.FranchiseID = 2"
    elif preference == "Ambas":
        query += " AND MovieTheater.FranchiseID = 1 OR 2"
